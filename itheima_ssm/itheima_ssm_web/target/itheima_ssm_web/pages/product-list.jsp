        ...
        <section class="content">
            ...
            <div class="box box-primary">
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
                            <li><a href="${pageContext.request.contextPath}/product/findAllProduct?size=${pageInfo.pageSize}" aria-label="Previous">首页</a></li>
                            ...
                            <c:forEach begin="1" end="${pageInfo.pages}" var="page">
                                <li><a href="${pageContext.request.contextPath}/product/findAllProduct?page=${page}&size=${pageInfo.pageSize}">${page}</a></li>
                            </c:forEach>

                            <li><a href="${pageContext.request.contextPath}/product/findAllProduct?page=${pageInfo.pageNum+1}&size=${pageInfo.pageSize}">下一页</a></li>
...
<script>
    function changePageSize() {
        ...
        //向服务器发送请求，改变没页显示条数
        location.href = "${pageContext.request.contextPath}/product/findAllProduct?page=1&size=" + pageSize;
    }
